...
package com.wys.lib.video.video;
...
import com.wys.lib.gpufilter.basefilter.GPUImageFilter;
import com.wys.lib.gpufilter.basefilter.MagicCameraInputFilter;
import com.wys.lib.video.gles.EglCore;
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(Constants.mContext.getResources());
